...
Meaning that the increase of $x_1$ by one unit causes the output to increase in average by $b_1$ (which can of course be negative). In our example, one additional watt will result in an increase of the average speed by 0.007 100m/min
...
- Fit a model for running activities to impute avgHr where it's missing
